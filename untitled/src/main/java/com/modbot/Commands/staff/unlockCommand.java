    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent event) {
        ...
        if(invoke.equals("unlock")){
            ...
            if (permissions == false) {
                ...
                event.getTextChannel().upsertPermissionOverride(event.getGuild().getPublicRole()).setAllowed(Permission.MESSAGE_SEND).queue();
                eb.setDescription("<:concluido:1000814178833010708>| " + user + " channel has been successfully unlocked");
            }
